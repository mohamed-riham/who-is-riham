...
- **Predictive Model Playground**: Models multi-metric performance comparisons of Random Forest and XGBoost classifiers trained over 1,000,000+ imbalanced transactions.
...
| :--- | :--- | :--- | :--- |
| **Frontend Core** | React 18+ & TypeScript | Strictly typed components, interfaces, and enums | 100% type-safety & zero runtime warnings |
| **Styling & HUD** | Tailwind CSS v4 | Responsive utility classes, grid systems, and custom filters | Fast rendering with utility architecture |
| **Animations** | Framer Motion (`motion/react`) | Layout transitions, staggered entrances, hover physics | Fluid 60fps animations |
| **Icons Library** | Lucide React | Uniform SVG vector assets used throughout layouts | Clean rendering across resolutions |
| **Audio OS** | Web Audio API | Custom oscillator click, chime, and swoosh synthesizers | Dynamic client-side synthesis |
| **3D Elements** | CyberGlobe | Visual coordinate clustering marking local demographic nodes | Responsive Canvas resize tracking |
| **Data Viz** | Recharts / Custom Canvas | Charts comparing metrics (Recall, Precision, AUC) | Real-time interactivity |
...
```
┌────────────────────────────────────────────────────────────────────────┐
│                        ML SYSTEM STABILITY CARD                        │
├──────────────────────────────────────┬─────────────────────────────────┤
│ Metric Parameter                     │ Evaluation Value                │
├──────────────────────────────────────┼─────────────────────────────────┤
│ Dataset Transactions Screened        │ 1,000,000+ Event Records        │
│ XGBoost Recall (Fraud Class)         │ 99.74% Accuracy Rating          │
│ SMOTE Synthesis Ratio                │ 1:1 Balance Ratio               │
...
<div align="center">
  <p>Designed and programmed with absolute structural integrity by M.A. Mohamed Riham.</p>
  <p>© 2026 M.A. Mohamed Riham. All Rights Reserved.</p>
</div>
